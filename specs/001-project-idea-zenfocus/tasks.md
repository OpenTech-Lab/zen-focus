...
### Contract Tests
- [ ] T009 [P] Contract test POST /api/auth/login in tests/contract/auth-login.test.ts
- [ ] T010 [P] Contract test POST /api/auth/register in tests/contract/auth-register.test.ts
