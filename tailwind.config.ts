...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // ZenFocus color palette based on research.md
        primary: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
          300: '#6ee7b7',
          400: '#34d399',
          500: '#10b981', // Main emerald color for Study mode
          600: '#059669',
          700: '#047857',
          800: '#065f46',
          900: '#064e3b',
        ...
        secondary: {
          ...
          300: '#93c5fd',
          400: '#60a5fa',
          500: '#3b82f6', // Blue for Deep Work mode
          600: '#2563eb',
          700: '#1d4ed8',
          800: '#1e40af',
          900: '#1e3a8a',
        ...
        accent: {
          ...
          300: '#d8b4fe',
          400: '#c084fc',
          500: '#8b5cf6', // Violet for Yoga mode
          600: '#7c3aed',
          700: '#6d28d9',
          800: '#5b21b6',
          900: '#4c1d95',
