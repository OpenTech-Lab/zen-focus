...
describe('PersistenceService', () => {
    ...
    describe('Sessions', () => {
      ...
      it('should get sessions by user ID', async () => {
        ...
        const session1 = createSession(
          { mode: 'study', plannedDuration: 25, ambientSound: 'rain' },
          userId
        )
        const session2 = createSession(
          { mode: 'deepwork', plannedDuration: 50, ambientSound: 'forest' },
          userId
        )
  ...
  describe('Data Integrity and Validation', () => {
    it('should validate data before saving', async () => {
      ...
      await expect(persistenceService.saveUser(invalidUser as any)).rejects.toThrow(
        PersistenceError
      )
    })
  ...
  describe('Export and Import', () => {
    ...
    it('should import user data and validate integrity', async () => {
      ...
      const importData = {
        ...
        sessions: [
          createSession({ mode: 'zen', plannedDuration: 15, ambientSound: 'ocean' }, userId),
        ],
        customIntervals: [
