...
Always follow the instructions in TASKS.md. When I say "go", find the next unmarked test in TASKS.md, work with subagents, then implement the test, then implement only enough code to make that test pass.
