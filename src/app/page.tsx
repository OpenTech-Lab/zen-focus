            ...
            <Tabs defaultValue="study" className="w-full">
              ...
              <TabsContent value="study" className="space-y-4">
                <div className="text-center">
                  ...
                  <Badge variant="secondary" className="mt-2">Pomodoro Technique</Badge>
                </div>
              </TabsContent>
              ...
              <TabsContent value="deepwork" className="space-y-4">
                <div className="text-center">
                  ...
                  <Badge variant="secondary" className="mt-2">Deep Work Session</Badge>
                </div>
              </TabsContent>
              ...
              <TabsContent value="yoga" className="space-y-4">
                <div className="text-center">
                  ...
                  <Badge variant="secondary" className="mt-2">Mindful Movement</Badge>
                </div>
              </TabsContent>
              ...
              <TabsContent value="zen" className="space-y-4">
                <div className="text-center">
                  ...
                  <Badge variant="secondary" className="mt-2">Open-ended Focus</Badge>
                </div>
              </TabsContent>
            </Tabs>
